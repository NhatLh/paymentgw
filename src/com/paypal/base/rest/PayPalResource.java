...
public abstract class PayPalResource extends PayPalModel {
    ...
    private static final Logger log = Logger.getLogger(PayPalResource.class);
     ...
     * @return	OAuthTokenCredential instance with client ID and client secret
     ...
     * @return	OAuthTokenCredential instance with client ID and client secret in
     * given properties.
     */
    ...
    /**
     * Returns OAuthTokenCredential instance using client ID and client secret
     ...
     * {@link #configureAndExecute(APIContext, HttpMethod, String, String, Class)}
     * instead. Passing APIContext gives us better information than just raw
     * access token.
     *
     ...
     * @deprecated Please use
     * {@link #configureAndExecute(APIContext, HttpMethod, String, String, Class)}
     * instead. Headers could be passed directly to #APIContext itself.
     *
     * @param <T>
     * @param apiContext {@link APIContext} to be used for the call.
     * @param httpMethod Http Method verb
     ...
     * @param apiCallPreHandler {@link APICallPreHandler} for retrieving
     * EndPoint
     * @return
    ...
    /**
     * Returns ClientCredentials with client id and client secret from
     * configuration Map
     *
    ...
    /**
     * Merges properties object with the configuration hash map. The
     * configuration values are given higher priority.
     *
     * @param properties
     */
