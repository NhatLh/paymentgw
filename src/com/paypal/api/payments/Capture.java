...
public class Capture extends PayPalResource {
    ...
    /**
     * The amount to capture. If the amount matches the orginally authorized
     * amount, the state of the authorization changes to `captured`. If not, the
     * state of the authorization changes to `partially_captured`.
     */
    private Amount amount;

    /**
     * Indicates whether to release all remaining funds that the authorization
     * holds in the funding instrument. Default is `false`.
     */
    ...
    /**
     * The reason code that describes why the transaction state is pending or
     * reversed.
     */
    ...
    /**
     * The date and time of capture, as defined in [RFC 3339 Section
    ...
    /**
     * Creates (and processes) a new Refund Transaction added as a related
     * resource.
     *
     ...
     * Refunds a captured payment, by ID. Include an `amount` object in the JSON
     * request body.
     * @param apiContext {@link APIContext} used for the API call.
     * @param refund Refund
     * @return Refund
