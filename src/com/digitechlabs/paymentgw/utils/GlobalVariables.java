...
//    public static final String PAYPAL_REFUND_STATUS_SUCCESS = "completed";
    public static final String SQL_SELECT_USERID_FOR_UPDATE = "SELECT id, balance, award, wallet_add FROM user_wallet WHERE user_id =? AND wallet_type =? AND is_active = true FOR UPDATE";
    ...
    public static final String SQL_GET_BALANCE = "select balance from user_wallet where user_id = ? and wallet_type = ? and is_active = true";
    ...
    public static final String SQL_SELECT_HIS_BY_TYPE = "SELECT id, status, amount, created_at,from_address, to_address, currency,transaction_type, order_id, transaction_id FROM history WHERE user_id =? and created_at > ? and created_at < ? AND is_deleted = 'false' AND transaction_type in (?) order by created_at desc";
    ...
    public static final String SQL_SELECT_HIS = "SELECT id, status, amount, created_at,from_address, to_address, currency,transaction_type, order_id, transaction_id FROM history WHERE user_id =? and created_at > ? and created_at < ? AND is_deleted = 'false' AND transaction_type in (?,?,?,?) order by created_at desc";
    ...
    public static final String SELECT_INFO_REFUND = "SELECT user_id, amount FROM withdraw_his WHERE transaction_id =?";
    ...
    public static final String INSERT_HISTORY = "INSERT INTO history (id, status, amount, created_at, from_address, to_address, transaction_type, user_id, expired_time, currency, order_id,transaction_id) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)";
